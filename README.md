...
This repository was created from `danlysiak/govuk-prototype-template` and migrates the reviewed content and behaviour from the archived `ys-proto` standalone HTML prototype. The original shipped files remain unchanged in that repository.
